...
const (
	UserService_UserLogin_FullMethodName    = "/account.UserService/UserLogin"
	UserService_UserRegister_FullMethodName = "/account.UserService/UserRegister"
	UserService_UserDelete_FullMethodName   = "/account.UserService/UserDelete"
	UserService_UserUpdate_FullMethodName   = "/account.UserService/UserUpdate"
	UserService_UserQuery_FullMethodName    = "/account.UserService/UserQuery"
)
...
const (
	RelationsService_UserRelationsUpdate_FullMethodName = "/account.RelationsService/UserRelationsUpdate"
	RelationsService_UserRelationsGet_FullMethodName    = "/account.RelationsService/UserRelationsGet"
)
...
func (c *relationsServiceClient) UserRelationsUpdate(ctx context.Context, in *UserRelationsUpdateReq, opts ...grpc.CallOption) (*UserRelationsUpdateResp, error) {
	...
	err := c.cc.Invoke(ctx, RelationsService_UserRelationsUpdate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationsServiceClient) UserRelationsGet(ctx context.Context, in *UserRelationsGetReq, opts ...grpc.CallOption) (*UserRelationsGetResp, error) {
	...
	err := c.cc.Invoke(ctx, RelationsService_UserRelationsGet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRelationsServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedRelationsServiceServer) testEmbeddedByValue()                          {}
...
func RegisterRelationsServiceServer(s grpc.ServiceRegistrar, srv RelationsServiceServer) {
	// If the following call pancis, it indicates UnimplementedRelationsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
var RelationsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "account.RelationsService",
