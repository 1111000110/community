...
func (c *reviewServiceClient) ReviewCreate(ctx context.Context, in *ReviewCreateReq, opts ...grpc.CallOption) (*ReviewCreateResp, error) {
	...
	err := c.cc.Invoke(ctx, ReviewService_ReviewCreate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) ReviewDelete(ctx context.Context, in *ReviewDeleteReq, opts ...grpc.CallOption) (*ReviewDeleteResp, error) {
	...
	err := c.cc.Invoke(ctx, ReviewService_ReviewDelete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) ReviewDeleteByHeadId(ctx context.Context, in *ReviewDeleteByHeadIdReq, opts ...grpc.CallOption) (*ReviewDeleteResp, error) {
	out := new(ReviewDeleteResp)
	err := c.cc.Invoke(ctx, ReviewService_ReviewDeleteByHeadId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) ReviewGetByBaseId(ctx context.Context, in *ReviewGetByBaseIdReq, opts ...grpc.CallOption) (*ReviewGetResp, error) {
	...
	err := c.cc.Invoke(ctx, ReviewService_ReviewGetByBaseId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) ReviewGetByRootId(ctx context.Context, in *ReviewGetByRootIdReq, opts ...grpc.CallOption) (*ReviewGetResp, error) {
	out := new(ReviewGetResp)
	err := c.cc.Invoke(ctx, ReviewService_ReviewGetByRootId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
